...
export const CONNECTOR_DIRECTORY: ConnectorDirectoryEntry[] = [
  {
    ...
    supported_actions: ['Search files', 'Read documents', 'Upload files'], keywords: ['google', 'drive', 'files', 'documents', 'storage'], recommended_employee_ids: ['data_analyst', 'cybersecurity_analyst', 'backend_developer', 'qa_engineer'], setup_copy: 'Connect your Google Workspace once, then grant only the employees who need Drive.'
  },
  {
    ...
    supported_actions: ['Search threads', 'Draft messages', 'Send with approval'], keywords: ['google', 'gmail', 'email', 'inbox', 'messages'], recommended_employee_ids: ['data_analyst', 'cybersecurity_analyst', 'backend_developer', 'qa_engineer'], setup_copy: 'Connect Gmail with least-privilege scopes. Sending remains approval-gated by default.'
  },
  {
    ...
    supported_actions: ['Find availability', 'Draft events', 'Create approved events'], keywords: ['google', 'calendar', 'schedule', 'meetings', 'availability'], recommended_employee_ids: ['backend_developer', 'qa_engineer'], setup_copy: 'Connect Calendar, choose the employees who can coordinate time, and keep event creation reviewable.'
  },
  {
    ...
    supported_actions: ['Find templates', 'Create design drafts', 'Export approved assets'], keywords: ['canva', 'design', 'creative', 'templates', 'assets'], recommended_employee_ids: ['data_analyst'], setup_copy: 'Select the official Canva MCP remote during setup, then assign approved specialist.'
  },
  {
    ...
    supported_actions: ['Search pages', 'Read knowledge', 'Draft updates'], keywords: ['notion', 'wiki', 'knowledge', 'docs', 'roadmap'], recommended_employee_ids: ['data_analyst', 'backend_developer', 'qa_engineer', 'cybersecurity_analyst'], setup_copy: 'Connect the workspace once and use tool-level grants to decide who can read or update pages.'
  },
  {
    ...
    supported_actions: ['Search files', 'Read mail', 'Draft calendar changes'], keywords: ['microsoft', 'office', 'outlook', 'sharepoint', 'onedrive'], recommended_employee_ids: ['data_analyst', 'cybersecurity_analyst'], setup_copy: 'Choose the tenant-approved Microsoft 365 remote and keep write actions reviewable.'
  },
  {
    ...
    supported_actions: ['Read files', 'Inspect designs', 'Create design briefs'], keywords: ['figma', 'design', 'prototype', 'ui', 'ux'], recommended_employee_ids: ['backend_developer', 'qa_engineer'], setup_copy: 'Connect the approved Figma MCP remote and start with read-only design context.'
  },
  {
    ...
    supported_actions: ['Search issues', 'Draft tickets', 'Update approved work'], keywords: ['atlassian', 'jira', 'confluence', 'issues', 'sprint'], recommended_employee_ids: ['backend_developer', 'qa_engineer'], setup_copy: 'Connect Jira and Confluence, then assign technical and operations access separately.'
  },
  {
    ...
    supported_actions: ['Search messages', 'Draft updates', 'Post with approval'], keywords: ['slack', 'chat', 'messages', 'channels', 'alerts'], recommended_employee_ids: ['backend_developer', 'qa_engineer', 'cybersecurity_analyst', 'data_analyst'], setup_copy: 'Connect Slack and require approval before external or broad channel messages.'
  },
  {
    ...
    supported_actions: ['Search contacts', 'Review deals', 'Draft follow-ups'], keywords: ['hubspot', 'crm', 'sales', 'leads', 'pipeline'], recommended_employee_ids: ['data_analyst'], setup_copy: 'Connect HubSpot with read-first grants. Contact updates and outreach stay reviewable.'
  },
  {
    ...
    supported_actions: ['Search issues', 'Plan cycles', 'Draft issue updates'], keywords: ['linear', 'issues', 'cycles', 'roadmap', 'engineering'], recommended_employee_ids: ['backend_developer', 'qa_engineer'], setup_copy: 'Connect Linear and let engineering prepare updates before changes are made.'
  },
  {
    ...
    supported_actions: ['Read boards', 'Draft updates', 'Update approved items'], keywords: ['monday', 'boards', 'projects', 'tasks', 'operations'], recommended_employee_ids: ['qa_engineer', 'backend_developer'], setup_copy: 'Connect the workspace and use approval-gated updates for shared boards.'
  },
  {
    ...
    supported_actions: ['Read repositories', 'Review issues and PRs', 'Create approved changes'], keywords: ['github', 'git', 'repository', 'pull request', 'code', 'ci'], recommended_employee_ids: ['backend_developer', 'qa_engineer', 'cybersecurity_analyst'], setup_copy: 'Connect GitHub with repository-level access. Write actions remain approval-gated unless explicitly enabled.'
  },
  {
    ...
    connection_mode: 'google_oauth', connection_type: 'google_sheets', default_access_level: 'requires_approval',
    supported_actions: ['Read ranges', 'Prepare updates', 'Write approved changes'], keywords: ['google', 'sheets', 'spreadsheet', 'finance', 'data'], recommended_employee_ids: ['data_analyst'], setup_copy: 'Connect Sheets and assign access to the employee who owns the workflow.'
  },
  {
    ...
    supported_actions: ['Discover tools', 'Grant read access', 'Approve write actions'], keywords: ['custom', 'mcp', 'private', 'proprietary', 'internal'], recommended_employee_ids: ['backend_developer', 'cybersecurity_analyst', 'data_analyst', 'qa_engineer'], setup_copy: 'Use an HTTPS MCP endpoint, configure authentication, and review discovered tools before granting access.'
  }
];
