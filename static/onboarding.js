document.addEventListener("DOMContentLoaded", () => {
  ...
  const customSkills = {};
  const planNames = { free_trial: "Free Trial (3 Days)", pro: "Starter", starter: "Starter", growth: "Growth", enterprise: "Enterprise" };
  const planTotals = { free_trial: "Free for 3 days", pro: "₹5 / month", starter: "₹5 / month", growth: "₹10 / month", enterprise: "₹15 / month" };
